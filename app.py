...
def say_hello_and_age_page(name, age):
    return """
     <html>
         <head>
             <title>Flask App</title>
...
def say_hello_and_age_page_url(name, age):
...
# @app.route('/about')
# def about_page():
#     page_endpoint = url_for('greeting', name="Saynab")
#     return """
#     <html>
#          <head>
#              <title>Flask App</title>
...
#          </body>
#     </html>
#     """.format(page_endpoint)

# more developed about page
@app.route('/about')
def about_page():
